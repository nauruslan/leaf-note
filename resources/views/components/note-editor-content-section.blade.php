@props([
    ...
    'content' => null,
    'note' => null,
    'editorId' => 'note-view-editor',
    'imageUploadInputId' => 'note-view-image-upload-input',
    'contentInputId' => 'note-view-content-input',
...
<div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 pb-6">
    <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden min-h-[600px] flex flex-col">
        ...
        <div wire:ignore>
            ...
            <input type="file" id="{{ $imageUploadInputId }}" accept="image/*" style="display:none">
        ...
        <div
            ...
            <div wire:ignore class="flex items-center gap-4">
                <span>Создано: {{ $note?->created_at?->translatedFormat('d F Y') ?? 'только что' }}</span>
                <span>•</span>
                <span>Изменено: {{ $note?->updated_at?->translatedFormat('d F Y') ?? 'только что' }}</span>
                <span>•</span>
