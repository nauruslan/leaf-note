   ...
   <div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 mb-6 flex flex-wrap gap-5">
     ...
     <div
           ...
           <div class="flex items-center gap-4 justify-center">
             ...
             <div class="relative w-[100px] h-[100px]">
               <svg viewBox="0 0 100 100" class="absolute top-0 left-0 w-full h-full"
                 ...
                 <!-- Progress Circle -->
                 <circle cx="50" cy="50" r="45" class="fill-none stroke-indigo-600 transition-all duration-500"
                   stroke-width="8" stroke-linecap="round" stroke-dasharray="283" stroke-dashoffset="198.1" />
               </svg>
       ...
       <div class="flex justify-between border-t border-gray-200 pt-5 mt-auto">
         <div class="px-3 py-1.5 rounded-lg text-md font-bold bg-indigo-100 text-indigo-800 flex items-center gap-1.5">
