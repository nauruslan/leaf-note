<div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <x-dropdown
                            ...
                            selected="{{ $is_favorite ? '1' : '0' }}"
                            wireModel="is_favorite"
                            live
                            width="80px"
                        />
                    </div>
    ...
    <div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 pb-6">
        <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden min-h-[600px] flex flex-col">
            ...
            <input type="hidden" wire:model.live.debounce.500ms="content" id="note-content-input">
            ...
            <div
                ...
                <div wire:ignore class="flex items-center gap-4">
                    <span>Создано: {{ $this->note?->created_at?->translatedFormat('d F Y') ?? 'только что' }}</span>
                    <span>•</span>
                    <span>Изменено: {{ $this->note?->updated_at?->translatedFormat('d F Y') ?? 'только что' }}</span>
                    <span>•</span>
