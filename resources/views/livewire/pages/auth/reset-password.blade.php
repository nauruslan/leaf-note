...
<div>
    ...
    <form wire:submit="resetPassword" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="email" id="email" wire:model="email"
                    ...
                    placeholder="Введите ваш email" required autocomplete="username" />
            </div>
            @error('email')
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="password" id="password" wire:model="password"
                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                    placeholder="Введите новый пароль" required autocomplete="new-password" />
            </div>
            @error('password')
                <span class="text-red-500 text-sm mt-1 inline-block">{{ $message }}</span>
            @enderror
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="password" id="password_confirmation" wire:model="password_confirmation"
                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                    placeholder="Подтвердите новый пароль" required autocomplete="new-password" />
            </div>
        ...
        <button type="submit" wire:loading.attr="disabled"
            ...
            <span wire:loading.remove>Сохранить новый пароль</span>
