<div>
    <!-- Unified Archive Component (Header + ControlPanel + Content) -->
    <!-- Header Section -->
        ...
        <div
            ...
            <div class="flex items-start justify-between mb-6">
                ...
                <div class="flex flex-1 ml-3 flex-col">
                    <h3 class="font-bold text-lg text-gray-900">Архивированная заметка</h3>
                    <p class="text-xs text-gray-500">Создано: 1 марта 2026</p>
                </div>
            ...
            <div class="flex-grow flex">
                <p class="text-gray-600">Эта заметка была перемещена в архив. Вы можете восстановить её или удалить
                    навсегда.</p>
            </div>
