...
<body class="bg-gradient-to-br from-indigo-50 to-purple-50 min-h-screen py-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex flex-wrap items-center gap-4 justify-end">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-sm font-medium text-gray-700 whitespace-nowrap">Вид:</span>
                        <div class="relative">
                            <select
    ...
    <!-- Notes Grid -->
    <div class="max-w-[1536px] px-4 sm:px-6 lg:px-8 mb-6 flex flex-wrap gap-5">
        <!-- Card 1: Рабочие задачи (с прогрессом) -->
        <div
            class="min-w-[320px] basis-[320px] h-[340px] flex flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
        ...
        <div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-md p-5 border border-gray-100">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center justify-center md:justify-end gap-3 sm:gap-5">
                        ...
                        <a href="#"
                            ...
                            <i data-lucide="life-buoy" class="w-4 h-4 group-hover:scale-110 transition-transform"></i>
                            <span>Поддержка</span>
                        </a>
                        <a href="#"
                            class="group flex items-center gap-1.5 text-sm font-medium text-gray-600 hover:text-indigo-600 transition-colors duration-200"
                ...
                <div class="mt-5 pt-5 border-t border-gray-100">
                    <div
                        class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-center sm:text-left">
                        <div class="text-xs text-gray-400 flex items-center justify-center gap-2">
                            <i data-lucide="leaf" class="w-3.5 h-3.5 text-green-500"></i>
                            <span>Создано с заботой о вашей продуктивности</span>
                        </div>
                        <div class="flex items-center justify-center gap-2">
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded-md bg-indigo-50 text-indigo-700 text-xs font-medium">
    ...
    <script>
        // Инициализация иконок Lucide (если еще не вызвана)
