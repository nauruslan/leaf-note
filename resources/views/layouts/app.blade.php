...
<body class="bg-gradient-to-br from-indigo-50 to-purple-50 min-h-screen">
            ...
            <ul class="space-y-1">
                ...
                <li>
                    ...
                    <ul class="mt-1 space-y-1">
                        <li>
                            <a href="#"
                                class="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 hover:text-indigo-600 transition-all group/item bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                        ...
                        <li>
                            <a href="#"
                                ...
                                <i data-lucide="list-check" class="w-6 h-6 flex-shrink-0"></i>
                                <span
                                    class="ml-3 font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">Списки
                                    задач</span>
                                <span
                                    class="ml-auto bg-indigo-100 text-indigo-700 text-xs font-medium px-2 py-0.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">12</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                ...
                <!-- Разделитель -->
                <li
                    class="my-2 mx-4 h-px bg-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                </li>
                    ...
                    <ul class="mt-1 space-y-1">
                        <li>
                            <a href="#"
                                ...
                                <span
                                    class="ml-3 font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">Работа</span>
                                <span
                                    class="ml-auto bg-amber-100 text-amber-800 text-xs font-medium px-2 py-0.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">15</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 hover:text-indigo-600 transition-all group/item">
                                <i data-lucide="heart" class="w-6 h-6 flex-shrink-0 text-pink-500"></i>
                                <span
                                    class="ml-3 font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">Личное</span>
                                <span
                                    class="ml-auto bg-pink-100 text-pink-800 text-xs font-medium px-2 py-0.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">9</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 hover:text-indigo-600 transition-all group/item">
                                <i data-lucide="lightbulb" class="w-6 h-6 flex-shrink-0 text-yellow-500"></i>
                                <span
                                    class="ml-3 font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">Идеи</span>
                                <span
                                    class="ml-auto bg-yellow-100 text-yellow-800 text-xs font-medium px-2 py-0.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">6</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 hover:text-indigo-600 transition-all group/item">
                                <i data-lucide="graduation-cap" class="w-6 h-6 flex-shrink-0 text-blue-500"></i>
                                <span
                                    class="ml-3 font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">Обучение</span>
                                <span
                                    class="ml-auto bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">3</span>
                            </a>
                        </li>
    ...
    <div class="ml-16">
        ...
        <div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 mb-6 flex flex-wrap gap-5">
            ...
            <div
                ...
                <div class="flex items-start justify-between mb-6">
                    ...
                    <div class="self-stretch flex flex-end items-baseline">
                        <button class="text-gray-400 hover:text-yellow-400 p-1 mb-1"
            ...
            <!-- Card 3: Рабочие задачи (с прогрессом) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 4: Идеи для проекта (без прогресса) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 5: Рабочие задачи (с прогрессом) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 6: Идеи для проекта (без прогресса) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 7: Рабочие задачи (с прогрессом) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 8: Идеи для проекта (без прогресса) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 9: Рабочие задачи (с прогрессом) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 10: Идеи для проекта (без прогресса) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 11: Рабочие задачи (с прогрессом) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
            ...
            <!-- Card 12: Идеи для проекта (без прогресса) -->
            <div
                class="min-w-[320px] basis-[320px] h-[340px] flex grow flex-col p-4 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-8 flex-shrink-0 self-stretch">
        ...
        <!-- Footer-->
        <footer class="bg-gradient-to-br from-indigo-50 to-purple-50">
            <div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white rounded-t-xl shadow-md p-5 border border-gray-100">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <!-- Copyright Section -->
                        <div class="text-sm text-gray-500">
                            &copy; 2026 LeafNote. Все права защищены.
                        </div>
