...
<head>
    ...
    <title>Сброс пароля сейфа - Leaf Note</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 1.6; color: #4b5563;">
                                Мы получили запрос на сброс пароля сейфа в Leaf Note. После сброса пароля ваш сейф будет
                                открыт без защиты — любой, кто имеет доступ к вашему аккаунту, сможет просматривать
                                защищённые заметки.
                            </p>

                            <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 1.6; color: #4b5563;">
                                Если вы не запрашивали сброс пароля сейфа, проигнорируйте это письмо. Ваш сейф останется
                                защищённым.
                            </p>
