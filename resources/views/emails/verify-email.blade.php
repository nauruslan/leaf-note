                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 1.6; color: #4b5563;">
                                Благодарим вас за регистрацию в Leaf Note! Для завершения регистрации и подтверждения
                                вашего адреса электронной почты, пожалуйста, нажмите на кнопку ниже:
                            </p>
                            ...
                            <p
                                ...
                                <a href="{{ $verificationUrl }}"
                                    style="color: #4f46e5; text-decoration: underline;">{{ $verificationUrl }}</a>
                            </p>

                            <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 1.6; color: #6b7280;">
                                Ссылка действительна в течение 60 минут. Если вы не создавали аккаунт в Leaf Note,
